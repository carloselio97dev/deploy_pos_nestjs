...
export class ProductsController {
  constructor(
    ...
    private readonly updloadImageService: UploadImageService
  ...
  uploadImage(@UploadedFile() file:Express.Multer.File){
      if(!file){
        throw new BadRequestException('La Imagen es Obligatorio');
      }
      return this.updloadImageService.updloadFile(file)
  }
}
